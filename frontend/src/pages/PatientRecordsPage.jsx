        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filtered.map((p) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${p.riskCls}`}
                      >
                        {p.risk}
                      </span>
                    </td>
                    <td
                      className={`px-6 py-4 whitespace-nowrap text-sm font-semibold ${p.probCls}`}
                    >
                      {p.prob}
                    </td>
          ...
          <div className="px-6 py-4 border-t border-gray-200 flex items-center justify-between text-sm text-gray-600">
            ...
            <div className="flex items-center gap-2">
              <button
                className="px-3 py-1 rounded-lg border border-gray-300 hover:bg-gray-50 disabled:opacity-40"
                disabled
              >
                Prev
              </button>
