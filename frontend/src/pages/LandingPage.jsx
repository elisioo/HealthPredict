          ...
          <div className="text-center lg:text-left space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                Get accurate diabetes risk assessment using logistic regression and business analytics.
                Take control of your health with data-driven insights and personalized recommendations.
              </p>
            </div>
                  ...
                  <div className="relative">
                    <div className="w-32 h-32 mx-auto relative">
                      <svg className="w-32 h-32 transform -rotate-90" viewBox="0 0 128 128">
                        ...
                        <circle
                          cx="64" cy="64" r="56" fill="none" stroke="#2563EB" strokeWidth="8"
      ...
      <footer className="bg-white border-t border-gray-100 mt-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-600 mb-6 max-w-md">
                Advanced diabetes risk prediction platform using logistic regression and business analytics,
            ...
            <div>
              ...
              <div className="space-y-3">
                {['Privacy Policy', 'Terms of Service', 'HIPAA Compliance', 'Cookie Policy'].map((item) => (
                  <a key={item} href="#" className="block text-gray-600 hover:text-primary transition-colors text-sm">
                    {item}
                  </a>
                ))}
              </div>
          ...
          <div className="border-t border-gray-100 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">© 2024 HealthPredict. All rights reserved.</p>
