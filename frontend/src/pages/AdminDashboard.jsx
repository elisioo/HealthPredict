...
const users = [
  {
    ...
    predictions: 12,
    avatar:
      "https://ui-avatars.com/api/?name=Sarah+Johnson&background=EFF6FF&color=2563EB",
  },
  {
    id: 2,
    ...
    predictions: 247,
    avatar:
      "https://ui-avatars.com/api/?name=Michael+Chen&background=F3E8FF&color=7C3AED",
  },
  {
    id: 3,
    name: "James Wilson",
    ...
    predictions: 5,
    avatar:
      "https://ui-avatars.com/api/?name=James+Wilson&background=F3F4F6&color=6B7280",
  },
  {
    id: 4,
    name: "Emily Davis",
    ...
    predictions: 28,
    avatar:
      "https://ui-avatars.com/api/?name=Emily+Davis&background=FFF7ED&color=EA580C",
  },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          ...
          <p className="text-sm text-gray-500 mb-2">
            Based on {(24567).toLocaleString()} total predictions
          </p>
          <RiskDistribution />
