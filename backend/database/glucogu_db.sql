...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Mar 01, 2026 at 11:23 AM
...
CREATE TABLE `health_profiles` (
  ...
  `smoking_status` enum('non-smoker','former','current') DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `predictions`
  ...
  ADD CONSTRAINT `predictions_ibfk_2` FOREIGN KEY (`predicted_by`) REFERENCES `users` (`user_id`);
